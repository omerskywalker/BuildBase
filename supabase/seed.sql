...
-- ─── Exercises ───────────────────────────────────────────────────────────────
INSERT INTO exercises (id, name, muscle_group, equipment, coaching_cues, video_url, is_active) VALUES
(e_smith_squat,       'Smith Machine Squat',       'Quads, Glutes',        'Smith Machine',    'Feet shoulder-width, toes 15° out. Break at hips and knees simultaneously. Keep chest tall, knees tracking over toes.',                            null, true),
(e_goblet_squat,      'Goblet Squat',              'Quads, Glutes, Core',  'Dumbbell/Kettlebell', 'Hold weight at chest. Elbows inside knees at bottom. Drive up through full foot.',                                                             'https://www.youtube.com/watch?v=example_goblet_squat', true),
(e_bb_back_squat,     'Barbell Back Squat',        'Quads, Glutes, Core',  'Barbell, Rack',    'Bar on traps, not neck. Brace core before descent. Depth: hip crease below parallel. Drive knees out on ascent.',                                 'https://www.youtube.com/watch?v=example_barbell_squat', true),
(e_ham_curl,          'Hamstring Curl Machine',    'Hamstrings',           'Machine',          'Slow 2-second eccentric. Squeeze at top. Do not jerk the weight up.',                                                                               null, true),
(e_walking_lunge,     'Walking Lunges',            'Quads, Glutes, Balance','Bodyweight/DBs',  'Big step, back knee hovers 1 inch off floor. Front knee stays above ankle. Stand fully before next step.',                                         null, true),
(e_bw_hip_thrust,     'Bodyweight Hip Thrust',     'Glutes',               'Bench',            'Upper back on bench edge, feet flat. Drive hips up to full extension. Squeeze glutes at top for 1 second.',                                        null, true),
(e_bb_hip_thrust,     'Barbell Hip Thrust',        'Glutes',               'Barbell, Bench',   'Pad on bar. Upper back on bench. Drive through heels, full hip extension. Do not hyperextend lumbar.',                                             'https://www.youtube.com/watch?v=example_hip_thrust', true),
(e_db_shoulder_press, 'DB Shoulder Press',         'Shoulders',            'Dumbbells',        'Press straight up, slight forward lean acceptable. Stop just short of lockout. Control the descent.',                                              null, true),
(e_lateral_raise,     'Lateral Raises',            'Lateral Deltoids',     'Dumbbells',        'Slight elbow bend. Lead with elbows, not hands. Stop at shoulder height. Slow 3-second eccentric.',                                                null, true),
(e_rear_delt_fly,     'Rear Delt Fly',             'Rear Deltoids',        'Dumbbells',        'Hinge at hips, chest parallel to floor. Arms arc out to sides, thumbs pointing down. Squeeze shoulder blades.',                                   null, true),
(e_crunch,            'Crunches',                  'Abs',                  'Bodyweight',       'Hands behind head, elbows wide. Curl shoulder blades off floor — do not pull neck. Exhale at top.',                                                null, true),
(e_leg_raise,         'Leg Raises',                'Lower Abs',            'Bodyweight',       'Lower back pressed into floor. Legs together, lower to just above floor — do not touch. Raise controlled.',                                        null, true),
(e_plank,             'Plank',                     'Core',                 'Bodyweight',       'Forearms under shoulders. Hips level — no sagging or piking. Breathe. Brace as if taking a punch.',                                                null, true),
(e_dead_bug,          'Dead Bug',                  'Core, Anti-rotation',  'Bodyweight',       'Lower back glued to floor the entire time. Opposite arm and leg lower slowly. Exhale as limbs lower.',                                             null, true),
(e_bic_curl_sup,      'Supinating Bicep Curl',     'Biceps',               'Dumbbells',        'Start with palms facing in, rotate to palms-up at top. Full supination. Squeeze at top, slow on the way down.',                                   null, true),
(e_skull_crusher,     'Skull Crusher',             'Triceps',              'Dumbbells',        'Upper arms vertical, only forearms move. Lower to temples — do not flare elbows wide. Press straight up.',                                         null, true),
(e_hammer_curl,       'Hammer Curl',               'Brachialis, Biceps',   'Dumbbells',        'Neutral grip (palms facing in) throughout. Do not swing. Both arms or alternating, full range of motion.',                                         null, true),
(e_tri_kickback,      'Tricep Kickback',           'Triceps',              'Dumbbells',        'Hinge forward. Upper arm parallel to floor. Extend fully — squeeze tricep hard at lockout. Control descent.',                                      null, true),
(e_rdl,               'Romanian Deadlift',         'Hamstrings, Glutes',   'Dumbbells',        'Soft knee bend, hinge at hips. Bar (or DBs) close to legs. Feel hamstring stretch. Drive hips forward to stand.',                                 'https://www.youtube.com/watch?v=example_rdl', true),
(e_one_arm_row,       'One-Arm DB Row',            'Lats, Rhomboids',      'Dumbbell, Bench',  'Brace on bench. Pull elbow to hip, not shoulder. Full extension at bottom. Do not rotate torso.',                                                  null, true),
(e_db_chest_press,    'DB Chest Press',            'Chest, Triceps',       'Dumbbells, Bench', 'Press up and slightly together. Do not lock out. Control descent — elbows 45° from torso, not flared.',                                           null, true),
(e_bicep_curl,        'Bicep Curl',                'Biceps',               'Dumbbells',        'Elbows pinned to sides. No swinging. Full extension at bottom. Squeeze at top.',                                                                   null, true),
(e_tri_pushdown,      'Tricep Pushdown',           'Triceps',              'Cable Machine',    'Elbows at sides, press down to full extension. Squeeze. Controlled return — do not let elbows drift forward.',                                     null, true),
(e_trap_bar_dl,       'Trap Bar Deadlift',         'Hamstrings, Glutes, Back', 'Trap Bar',     'Stand in center of bar. Hip hinge to grip. Brace, then drive floor away. Hips and shoulders rise together.',                                      null, true),
(e_conv_dl,           'Conventional Deadlift',     'Posterior Chain',      'Barbell',          'Bar over mid-foot. Hip-width stance. Hinge, grip just outside shins. Brace hard. Drive hips and shoulders up together. Bar stays close.',          'https://www.youtube.com/watch?v=example_deadlift', true),
(e_lat_pulldown,      'Lat Pulldown',              'Lats',                 'Cable Machine',    'Lean back slightly. Pull bar to upper chest, lead with elbows. Squeeze lats at bottom. Slow return.',                                              'https://www.youtube.com/watch?v=example_lat_pulldown', true),
(e_seated_cable_row,  'Seated Cable Row',          'Rhomboids, Lats',      'Cable Machine',    'Sit tall. Pull handle to navel — squeeze shoulder blades together. Do not rock torso. Slow controlled return.',                                    null, true),
(e_incline_pushup,    'Incline Push-up',           'Chest, Triceps, Core', 'Bench/Box',        'Hands on elevated surface, body straight plank. Lower chest to surface. Elbows 45°. Full range.',                                                 null, true),
(e_floor_pushup,      'Push-up',                   'Chest, Triceps, Core', 'Bodyweight',       'Hands shoulder-width, body rigid plank. Chest touches floor. Drive back to full arm extension.',                                                   null, true),
(e_face_pull,         'Face Pull',                 'Rear Delts, Rotator Cuff', 'Cable Machine', 'Rope attachment at forehead height. Pull to face, elbows flare out. External rotation at end. Non-negotiable for shoulder health.',              null, true),
(e_bicycle_crunch,    'Bicycle Crunches',          'Obliques, Abs',        'Bodyweight',       'Rotate shoulder to opposite knee. Full extension of leg. Do not pull neck. Slow and controlled — not a race.',                                     null, true),
(e_hollow_body,       'Hollow Body Hold',          'Core',                 'Bodyweight',       'Arms overhead, lower back pressed to floor. Lift legs and shoulders. Hold. The lower the legs, the harder it is — start higher.',                  null, true);
