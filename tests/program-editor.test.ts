...
import { GET as programGET } from "../app/api/admin/programs/[programId]/route";
import { PUT as phasePUT } from "../app/api/admin/programs/[programId]/phases/route";
...
describe("Program Editor API", () => {
  ...
  describe("PUT /api/admin/programs/[programId]/phases", () => {
    const mockRequest = (body: any) =>
      ({
        json: () => Promise.resolve(body),
      }) as Request;
