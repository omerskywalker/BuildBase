  ...
  // ── Phase 12: Core Loop Features ──────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        issue: 108,
        scope: {
          owns: ["app/(coach)/playbook/", "app/api/coach/playbook/", "supabase/migrations/007_playbook_entries.sql"],
  ...
  // ── Phase 13: Code Cleanup ────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        issue: 105,
        scope: {
          owns: ["supabase/migrations/008_add_indexes.sql"],
          avoid: [],
        },
      },
    ],
    ...
    items: [
      {
        ...
        issue: 111,
        scope: {
          owns: ["app/api/coach/notify-note/"],
          avoid: [],
        },
      },
      {
